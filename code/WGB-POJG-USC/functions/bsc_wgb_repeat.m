function metric_ave = bsc_wgb_repeat(data_matrix, label, cluster_num, wgb_num, options, repeat_num, metric_name)
...
%
    ...
    for item = 1:repeat_num
        ...
        % 运行一次 BSC-PGB 聚类算法
        label_pred = bsc_wgb(data_matrix, cluster_num, wgb_num, options);
        % 根据指定指标计算性能
