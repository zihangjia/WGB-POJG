function outputs = dpc_wgb_repeat_detailed(data_matrix, label, cluster_num, wgb_num, options, repeat_num, metric_name)
%BSC_WGB_REPEAT  多次运行 BSC-WGB 聚类算法并返回平均性能指标pgb
%
