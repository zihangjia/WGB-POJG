...
for no = 1:dataset_num
    ...
    outputs = dpc_wgb_repeat_detailed(data, label, class_num, wgb_num, options, 20, 'nmi');
    ...
    wgb_num = parameter(2);
    options = wgbOptions("hyperparameter_pojg", parameter(1), "learning_rate_feature_weight", parameter(3));
    outputs = dpc_wgb_repeat_detailed(data, label, class_num, wgb_num, options, 20, 'ari');
